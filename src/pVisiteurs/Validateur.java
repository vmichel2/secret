...
public class Validateur extends Visiteur {
    ...
    /*
    Data contient le type de l'objet retourn� par le visiteur, par exemple si on a un " true - 42 ", le visiteur renverra :
    "booleen" - "entier" pour chacunes des feuilles, puis ERROR pour la soustraction en elle m�me,
    car on ne peut pas soustraire un entier � un bool�en, le code ERROR remontera jusqu'au noeud racine.
     */
    ...
    public Object visit(AppartientA appartientA, Object data) {
        ...
        if (terminaux.contains(appartientA.getExpr().Accepte(this,data)) && // si on a bien un terminal � gauche
